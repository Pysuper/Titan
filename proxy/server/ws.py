...
#
#
# class WebSocketProxy(tornado.websocket.WebSocketHandler):
#     """
#     WebSocket代理类
#     1. 管理WebSocket连接
#     2. 处理WebSocket消息
...
#             # 尝试关闭连接
#             try:
#                 # self.close(code=1000, reason="WebSocket连接建立过程中出错")
#                 self.close()
#             except:
#                 pass
#
...
#         return None
from proxy.server.base import CustomWebSocket
